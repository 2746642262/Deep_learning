...
*   **李凯旋 (项目经理)**：系统架构设计、GUI 开发、数据库设计、统筹整合。
*   **陈姝灼 (产品经理)**：花卉识别模块 (Scene 1) 算法实现与文档。
*   **王梓蕾 (软件工程师)**：Titanic 预测模块 (Scene 2) 算法实现与文档。
*   **冯英洁 (系统工程师)**：服装识别模块 (Scene 3) 算法实现与文档。
*   **戈美叶 (UCD工程师)**：非线性回归模块 (Scene 4) 算法实现与文档。
*   **马乐然 (测试工程师)**：系统测试策略制定、自动化测试脚本编写。
